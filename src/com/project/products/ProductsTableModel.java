...
public class ProductsTableModel extends AbstractTableModel {
    ...
    String[] columnNames = {"Product name","Remote id","Category", "Action"};
    ...
    public ProductsTableModel(OnItemActionClickListener onItemActionClickListener){
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch(col){
            ...
            case 2: return productVM.getCategory();
